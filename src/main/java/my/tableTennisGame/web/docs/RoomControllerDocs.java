...
public interface RoomControllerDocs {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "유저 Id, 방 타입(단식/복식), 방 제목 정보", content = @Content(schema = @Schema(implementation = RoomReqDto.RoomCreateReqDto.class)))
